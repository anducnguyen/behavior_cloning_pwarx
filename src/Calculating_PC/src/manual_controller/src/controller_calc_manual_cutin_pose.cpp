...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()) {
		...
		fprintf(stdout,"speed_current = %.2f, speed_cmd = %.2f, steer_cmd = %.2f, speed_error = %.2f, speed_error_integration = %.2f, speed_error_derivative = %.2f, kp = %.2f\n", current_speed,dat.accel, dat.steer,speed_PIDcontrol.get_error(),speed_PIDcontrol.get_error_integration(), speed_PIDcontrol.get_error_derivative(),speed_PIDcontrol.get_Kp());
